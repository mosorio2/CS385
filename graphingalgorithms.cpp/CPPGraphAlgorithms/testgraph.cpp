 ...
 * Modified    : November 13, 2014, add shortest path
...
int main(int argc, char * const argv[]) {
    ...
    if (solution_vertices.size() == 0) {
        ...
        for (vector<uint_t>::iterator it = solution_vertices.begin();
                it != solution_vertices.end(); ++it) {
            if (it != solution_vertices.begin()) {
                cout << " ";
            }
            cout << *it;
        }
